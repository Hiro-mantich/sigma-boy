...
namespace {
struct qt_meta_tag_ZN12CardDelegateE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12CardDelegateE = QtMocHelpers::stringData(
    "CardDelegate"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12CardDelegateE[] = {
...
Q_CONSTINIT const QMetaObject CardDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12CardDelegateE.offsetsAndSizes,
    qt_meta_data_ZN12CardDelegateE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12CardDelegateE_t,
        // Q_OBJECT / Q_GADGET
...
void *CardDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12CardDelegateE.stringdata0))
